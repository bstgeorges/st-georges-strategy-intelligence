...
- **Deep Dive:** The current deep-dive route is `/deep-dives/harness-problem/`, sourced at `site/deep-dives/harness-problem/index.html`. It is integrated into the homepage, Weekly Brief, archive and publishing/sitemap flow. It uses FCA and FSB evidence to explore remediation capacity, control design and correlated cyber disruption; do not treat it as a disposable promotional card.
