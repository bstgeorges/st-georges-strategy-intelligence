...
2. `Signals candidates weekly refresh` collects and validates Signals candidates, then generates `dashboard/data/signals-promotion-review.generated.json` with `reviewStatus: pending`. Candidate generation never publishes the site.
