...
import { loadSnapshots, validateMachineContent, validateSnapshots } from "../scripts/content-validation.mjs";
...
test("machine-readable editorial feeds retain their audited shape", async () => {
  ...
  assert.equal(result.horizonSha256, "e989b716bab26276a473221b9c285ce607049a0a396538b37a6336a1abfcf1d6");
});
